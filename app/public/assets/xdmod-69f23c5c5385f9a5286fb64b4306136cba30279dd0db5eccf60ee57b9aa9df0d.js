...
function renderEfficiencyPanel(panelId, context) {
  ...
  if (context.error) {
    ...
    cardBody2.appendChild(efficiencyParagraph);
    ...
    cardBody2.appendChild(progressDiv);
    ...
    cardBody2.appendChild(countParagraph);
  }
  card2.appendChild(cardBody2);
  panel.replaceChildren(card2);
}
function renderJobsEfficiency(context) {
  renderEfficiencyPanel(jobEfficiencyPanelId, import_lodash.default.merge(context, { unit: "jobs", unit_title: "Jobs" }));
}
function renderCoreHoursEfficiency(context) {
  renderEfficiencyPanel(coreEfficiencyPanelId, import_lodash.default.merge(context, { unit: "core hours", unit_title: "Core Hours" }));
}
...
lodash/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=/assets/xdmod.js-6665c36cefe8e538d3ff47e8f412408bcc3f4f8ecf1c05ca529c074ed4dc905f.map
//!
;
