...
// app/javascript/module_browser.js
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  document.querySelectorAll('[data-role="copy-btn"]').forEach((button) => {
    button.addEventListener("click", () => {
      ...
      navigator.clipboard.writeText(text).then(() => {
        ...
        setTimeout(() => button.textContent = "Copy", 2e3);
      }).catch((err) => {
  ...
  moduleSearch.addEventListener("input", (0, import_lodash.debounce)(filterModules, 300));
...
lodash/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=/assets/module_browser.js-263742f2c1cd6269d04483818b9cd8feb2fb470eea4e95cb2efa1aad12f06bbf.map
//!
;
